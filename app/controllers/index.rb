...
post '/' do
  ...
  Pony.mail({
    ...
    # :html_body => "<h4>Name: #{name}</h4><h4>Phone number: #{phone}</h4><h4>Email: #{email}</h4><h4>Message: #{message}</h4>",
    :body => "Name: " + params[:name] + " | " + "Phone number: " + params[:phone] + " | " + "Email: " + params[:email] + " | " + "Message: " + params[:message],
